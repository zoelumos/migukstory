...
- Migukstory의 차별점은 시각화입니다. 초안에 유용한 시각화가 없으면 반드시 `## 한눈에 보는 변화` 섹션을 추가하고, 기사 성격에 맞게 Mermaid flowchart, 타임라인/단계 목록, 또는 Markdown 비교표 중 하나 이상을 넣으세요. 절차/자격/이민/혜택/정책 변경 글은 시각화 없이는 불완전한 글로 봅니다.
