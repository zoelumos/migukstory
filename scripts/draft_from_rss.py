...
본문 소제목(##/###) 중 최소 2개는 독자가 실제로 검색할 질문형으로 쓰세요
(예: "2027 COLA는 몇 %인가요?", "지금 신청해야 하나요?"). 질문형 소제목
바로 아래 첫 문장에서 40~60단어로 직접 답을 준 뒤 상세를 이어가세요 —
AI 검색(AI Overviews·ChatGPT·Perplexity)이 가장 잘 인용하는 패턴입니다.]
