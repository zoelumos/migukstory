---
title: '6/5 EAD 규칙안 + 로드아일랜드 법원 명령: 한인 취업허가·영주권 대기자가 지금 확인할 것'
description: '2026년 6월 5일 두 가지 큰 이민 변화가 동시에 나왔습니다. DHS는 재량적 고용허가(EAD) 대폭 제한 규칙안을 발표했고(의견수렴 8/4 마감), 로드아일랜드 연방법원은 여행금지 39개국 대상 이민 혜택 동결 정책 4건을 무효화했습니다. H-1B/L-1 신분조정 대기자, H-4 배우자, parole·deferred action으로 일하는 한인, E-Verify를 떠안는 고용주가 무엇을 확인하고 어떻게 대응할지 정리합니다.'
pubDate: '2026-06-27'
tags: ['EAD규칙안', '취업허가', 'parole', 'deferred-action', '이민소송', 'E-Verify']
category: 'immigration'
ageGroup: '35-55'
draft: false
author: 'steve-song'
editorNote: '6월 5일 하루에 방향이 정반대인 두 사건이 겹쳤습니다. 행정부는 재량적 EAD를 조이는 규칙안을 냈고, 법원은 39개국 혜택 동결을 풀었습니다. 한인 독자 중 다수가 EAD로 생계를 유지하거나 신분조정을 기다리는 만큼, 두 소식을 한 화면에서 정리하고 8월 4일 의견수렴 마감 전에 할 수 있는 실제 행동을 안내합니다. 법원 명령은 6월 말 현재 정부 항소·집행정지 신청이 진행 중이어서 상황이 바뀔 수 있다는 점을 본문에서 분명히 했습니다.'
faq:
  - q: "이번 EAD 규칙안이 H-1B나 L-1 신분으로 일하는 저에게도 적용되나요?"
    a: "직접 적용되지 않습니다. 이 규칙안은 '재량적(discretionary) EAD' 즉 인도적 가석방(parole, c11), 유예조치(deferred action, c14), 감독부 석방(OSUP, c18) 범주를 대상으로 합니다. H-1B·L-1 본인의 취업 권한은 비자 신분 자체에서 나오므로 이 규칙안 범위 밖입니다. 다만 배우자가 H-4 EAD로 일하거나, 가족 중 parole·deferred action으로 일하는 분이 있다면 영향을 받을 수 있고, 별개로 H-4 등 일부 EAD 자동연장은 이미 2025년 10월 30일부터 폐지된 점도 함께 확인해야 합니다."
  - q: "재량적 EAD 규칙안의 의견수렴은 언제까지이고 어떻게 제출하나요?"
    a: "공식 의견수렴 마감은 2026년 8월 4일입니다. regulations.gov에서 도켓 번호 USCIS-2026-0067을 검색해 'Comment'를 누르면 누구나 의견을 제출할 수 있습니다(신분·국적 무관). 본인 사례에 미칠 구체적 영향, 1년 유효기간·생체정보·E-Verify 요건의 현실적 부담을 사실 기반으로 적는 것이 효과적입니다."
  - q: "로드아일랜드 법원이 39개국 혜택 동결을 풀었다는데, 지금 제 케이스가 진행되나요?"
    a: "2026년 6월 말 현재 법원이 무효화한 4개 정책은 효력이 정지된 상태이고 USCIS도 이를 따른다고 밝혔습니다. 따라서 동결로 멈췄던 일부 취업허가·영주권 케이스가 다시 진행될 수 있습니다. 다만 정부가 항소(제1연방항소법원)하면서 판결 집행정지를 신청했고 그 결정이 아직 나지 않았습니다. 집행정지가 인용되면 동결이 되살아날 수 있으므로 '지금이 움직일 때'라는 점을 변호사와 확인하세요."
  - q: "한국은 여행금지 39개국에 포함되나요?"
    a: "한국은 해당 39개국에 포함되지 않습니다. 따라서 39개국 동결 정책은 한국 국적자에게 직접 적용되지 않았습니다. 그럼에도 이 글에서 다루는 이유는, 한인 커뮤니티에는 39개국 출신 배우자·가족·동료가 적지 않고, 무엇보다 이 판결이 'USCIS가 마음대로 케이스를 무기한 멈출 수 없다'는 원칙을 확인했기 때문입니다. 동시에 발표된 재량적 EAD 규칙안은 국적과 무관하게 parole·deferred action·OSUP로 일하는 한인에게 직접 영향을 줍니다."
---
...
재량적 EAD(parole·deferred action·OSUP) 심사는 대략 이런 흐름입니다.

1. **신청 접수**
2. **범죄 이력 심사:** 체포·기소·유죄 등 기록이 있으면 원칙적 불승인(경미·기각·말소 기록도 문제 될 수 있음). 특히 **(c)(18) 범주**는 좁은 예외를 빼고 사실상 폐지
3. **생체정보 제출:** 지문·사진 → FBI 범죄조회
4. **승인 시 유효기간:** 최대 1년(DACA 제외)
5. **갱신:** 고용주가 E-Verify 가입 시 검토 진행, 미가입 시 갱신 차질 위험
