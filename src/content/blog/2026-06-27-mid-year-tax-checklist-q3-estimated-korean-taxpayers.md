...
**원천징수되지 않는 소득(자영업·1099·임대·투자)이 있는지**부터 확인하세요.

- **그런 소득이 있다 →** 추정세 대상(Form 1040-ES)
  - **안전항(90% / 100% / 110%) 미달 →** 9/15 Q3 추정세 납부 또는 W-4 조정
  - **안전항 충족 →** 가산세 위험 낮음, 기록 정리만
- **W-2 급여만 있다 →** IRS 원천징수 점검 도구로 부족분 확인
  - **부족분 있음 →** 새 W-4 제출해 원천징수 인상
  - **부족분 없음 →** 가산세 위험 낮음, 기록 정리만
