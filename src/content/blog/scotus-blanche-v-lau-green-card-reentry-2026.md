---
title: '대법원 판결 Blanche v. Lau — 영주권자 해외 출국 전 반드시 알아야 할 재입국 위험'
description: '2026년 6월 23일 연방대법원이 6대 3으로 "영주권자 재입국 심사 기준을 낮춘다"는 판결을 내렸습니다. 입국 심사관이 기소나 유죄 판결 없이 "합리적 의심"만으로 영주권자를 재입국 신청자로 분류할 수 있어, 전과 기록이 있는 한인 영주권자는 해외 여행 전 반드시 이민 전문 변호사 상담이 필요합니다.'
pubDate: 2026-06-29
...
faq:
  - q: "Blanche v. Lau 판결이 나에게 직접 적용되나요?"
    a: "네. 판결은 2026년 6월 23일부터 즉시 효력이 발생합니다. CBP 입국심사관은 새 기준을 별도 통지나 정책 메모 없이 바로 적용할 수 있습니다."
  - q: "오래된 체포 기록이나 기각된 혐의도 문제가 되나요?"
    a: "됩니다. 판결은 '유죄 판결'이 아니라 '혐의 행위(commission)'로도 충분하다고 했습니다. 이전에 기각된 혐의나 오래된 체포 기록도 입국심사관이 '합리적 이유'로 사용할 수 있습니다."
  - q: "영주권 카드(I-551)가 압수되면 어떻게 되나요?"
    a: "공항에서 영주권 카드를 압수당하고 임시 I-94/I-551 스탬프를 받게 됩니다. 이 경우 고용주·은행·주택·학교·보험 증명에 차질이 생길 수 있으며, 추방 절차가 시작될 수도 있습니다."
  - q: "여행 전 어떤 조치를 취해야 하나요?"
    a: "이민 전문 변호사와 상담해 본인의 전과 기록 전체(체포·기소·기각·유죄 포함)를 검토하고, 해외 여행 시 위험 수준을 평가받아야 합니다. 한국계 이민 변호사 단체(AILA 또는 한인 법률 지원 단체)를 통해 초기 상담을 받을 수 있습니다."
---
...
```mermaid
flowchart TD
    A[영주권자 해외 출국 후 귀국] --> B{CBP, 전과 기록 확인}
    B -->|전과 없음| C[정상 입국 처리]
    B -->|전과 있음 - 판결 전| D[명확하고 확실한 증거 필요\n입증 책임: 정부]
    B -->|전과 있음 - 판결 후| E[합리적 이유만으로 충분\n입증 책임: 영주권자]
    D --> F[증거 불충분 → 정상 입국]
    E --> G[가석방parole 분류]
    G --> H[영주권 카드 압수 가능]
    H --> I[추방 절차 개시 가능]
