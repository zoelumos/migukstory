...
1. **고금리 카드·소비자 대출이 있나? (잔액 $1,000 이상)** → 월 여유자금의 80% 이상을 고금리 부채 상환에 우선 투입
2. **ARM 모기지나 변동금리 대출이 있나?** → 갱신 시점을 확인하고 고정금리 전환을 검토(금리 전망은 전문가 상담)
3. **현금 비상금이 3~6개월치 생활비 미만인가?** → 고이율(HY) 세이빙스 계좌(4.5~5.0% APY)로 비상금부터 적립
4. **투자 포트폴리오를 6개월 이상 안 봤나?** → 주식·채권 비중 리밸런싱, 단기 CD·T-Bill 편입 검토
5. **위에 모두 해당 없음** → 현재 전략 유지, 7월 14일 CPI 발표 후 재평가
