...
- 교회 바로 그 거리(**Anderson Ave**, Walk Score 86)에 예산권 2가구 실매물 존재 — `1154`($750k), `1612`($850k, 1905년 건축) 등.
- **$1M을 다 쓰면 목표 미달.** 포트리 재산세가 **연 2.11%(~$21k)**라 렌트 한 층으로는 적자에 가까움.
- **~$85만 협상 매입 + 좋은 층 월 $3,700 렌트 + 시니어 혜택(StayNJ, 연 최대 $7,750↓)** 조합 → **월 +$1,000~1,400** 달성.
